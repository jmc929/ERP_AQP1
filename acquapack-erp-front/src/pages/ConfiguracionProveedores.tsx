...
const ConfiguracionProveedores = () => {
  ...
  const cargarDatos = async (tipo: TipoRegistro) => {
    try {
      setLoading(true);
      let endpoint = `${API_BASE_URL}/api/configuracion-proveedores/${tipo}`;
  ...
  const handleCrear = async () => {
    ...
    try {
      setLoading(true);
      const endpoint = `${API_BASE_URL}/api/configuracion-proveedores/${tabActivo}`;
  ...
  const handleGuardarEdicion = async () => {
    ...
    try {
      setLoading(true);
      const endpoint = `${API_BASE_URL}/api/configuracion-proveedores/${tabActivo}/${editandoId}`;
  ...
  const handleEliminar = async (id: number) => {
    ...
    try {
      setLoading(true);
      const endpoint = `${API_BASE_URL}/api/configuracion-proveedores/${tabActivo}/${id}`;
      const response = await fetch(endpoint, {
        method: "DELETE",
      });
